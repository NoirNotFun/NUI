...
local function AddBlurOverlay(parent, blurAmount)
    ...
    -- Copy UICorner từ parent (nếu có)
...
-- HOVER EFFECT - CHỈ DÙNG CHO TAB, HEADER, DROPDOWN TEXT
...
local function AddSubtitle(parent, subtitleText, yOffset)
    ...
    subtitle.Font = "Gotham"  -- 🔥 SUBTITLE → Inter
...
function NoirUI:CreateWindow(settings)
    ...
    -- Mặc định các tùy chọn màu sắc và blur
    ...
    LoadingTitle.Font = "GothamBold"  -- 🔥 HEADER → Space Grotesk
    ...
    LoadingSub.Font = "Gotham"  -- 🔥 BODY TEXT → Inter
    ...
    LoadingPercent.Font = "GothamBold"  -- 🔥 ELEMENT NAME → Space Grotesk
    ...
    if settings.KeySystem then
        ...
        if not KeySolved then
            ...
            kstr.Thickness = 2
            kstr.Color = ACCENT
            -- Glow Stroke: dày 8px, mờ 0.6 (nổi bật hơn)
            ...
            KT.Font = "GothamBold"  -- 🔥 HEADER → Space Grotesk
            KT.TextSize = 16
            ...
            KSub.Font = "Gotham"  -- 🔥 SUBTITLE → Inter
            KSub.TextSize = 12
            KSub.BackgroundTransparency = 1
            KSub.ZIndex = 2
            
            -- KEY INPUT PLACEHOLDER → Inter
            ...
            KI.Text = ""
            KI.Font = "Gotham"  -- 🔥 PLACEHOLDER → Inter
            KI.TextSize = 12
            ...
            Note.Font = "Gotham"  -- 🔥 BODY TEXT → Inter
            Note.TextSize = 10
            Note.BackgroundTransparency = 1
            Note.TextWrapped = true
            Note.ZIndex = 2
            
            -- KEY BUTTON → Space Grotesk
            ...
            KB.Text = "XÁC NHẬN"
            KB.Font = "GothamBold"  -- 🔥 ELEMENT NAME → Space Grotesk
    ...
    Title.Font = "GothamBold"  -- 🔥 HEADER → Space Grotesk
    Title.TextSize = 14
    ...
    TopB("X", Color3.fromRGB(255, 100, 100), function()
        ...
        cbtn.Font = "GothamBold"  -- 🔥 ELEMENT NAME → Space Grotesk
        ...
        fbtn.Font = "GothamBold"  -- 🔥 ELEMENT NAME → Space Grotesk
    ...
    -- Glow Stroke: dùng mặc định (1+4=5px, mờ 0.8)
    AddGlowStroke(Side, ACCENT, 1, 1, 0.85)   -- glow dày 4px, mờ 0.85
    ...
    -- Glow Stroke: dùng mặc định (1+4=5px, mờ 0.8)
    AddGlowStroke(Cont, ACCENT, 1, 1, 0.7)    -- glow dày 6px, mờ 0.7
    ...
    function NoirUI:Notify(title, message, iconName, soundType)
        ...
        -- NOTIFICATION TITLE → Space Grotesk
        ...
        tl.Font = "GothamBold"  -- 🔥 HEADER → Space Grotesk
        tl.TextSize = 13
        ...
        ml.Font = "Gotham"  -- 🔥 BODY TEXT → Inter
        ml.TextSize = 11
    ...
    function Window:CreateTab(name, icon)
        ...
        tabStroke.ZIndex = 2
        -- Glow Stroke: mỏng và mờ hơn (3px, 0.9) - sẽ được hiển thị khi tab active
        ...
        BT.Font = "GothamBold"  -- 🔥 TAB → Space Grotesk
        BT.TextSize = 13
        ...
        SearchIcon.Font = "GothamMedium"  -- 🔥 ELEMENT NAME → Space Grotesk
        ...
        SearchBox.Font = "Gotham"  -- 🔥 PLACEHOLDER → Inter
        ...
        local function resetAllTabs()
            for _, v in pairs(TScroll:GetChildren()) do
                if v:IsA("TextButton") then
                    ...
                    if t then 
                        if useAutoContrast then
                            t.TextColor3 = GetContrastColor(v.BackgroundColor3)
                        else
                    ...
                    if stroke and stroke.Name ~= "GlowStroke" then 
                        stroke.Transparency = 1
                    end
                    local glowStroke = v:FindFirstChild("GlowStroke")
                    if glowStroke then
        ...
        B.MouseButton1Click:Connect(function()
            ...
            resetAllTabs()
            CreateTabSlideEffect(TabContainer, 0.15)
            
            BT.TextColor3 = ACCENT
            tabStroke.Transparency = 0
            if tabGlowStroke then
                tabGlowStroke.Transparency = 0.7
            end
        ...
        function Tab:CreateSection(title, noLine)
            ...
            lbl.Font = "GothamBold"  -- 🔥 SECTION → Space Grotesk
            lbl.TextSize = 11
            ...
            arrow.Font = "GothamMedium"  -- 🔥 ELEMENT NAME → Space Grotesk
            arrow.TextSize = 10
        ...
        -- PARAGRAPH: CARD TITLE → Space Grotesk, DESCRIPTION → Inter
        function Tab:CreateParagraph(opt)
            ...
            title.TextTransparency = 0
            title.Font = "GothamBold"  -- 🔥 CARD TITLE → Space Grotesk
            title.TextSize = 13
            title.BackgroundTransparency = 1
            title.TextXAlignment = "Left"
            ...
            content.Font = "Gotham"  -- 🔥 DESCRIPTION → Inter
            content.TextSize = 11
        ...
        -- TEXTBOX: ELEMENT NAME → Space Grotesk, PLACEHOLDER → Inter
        function Tab:CreateTextBox(opt)
            ...
            i.Font = "Gotham"  -- 🔥 PLACEHOLDER → Inter
            i.TextSize = 12
        ...
        -- BUTTON: ELEMENT NAME → Space Grotesk, BUTTON DESC → Inter
        function Tab:CreateButton(opt)
            ...
            b.TextTransparency = 0
            b.Font = "GothamMedium"  -- 🔥 ELEMENT NAME → Space Grotesk
            b.TextSize = 12
            ...
            if opt.Align == false then
                ...
                hint.Font = "Gotham"  -- 🔥 BUTTON DESC → Inter
                hint.TextSize = 10
        ...
        -- TOGGLE: ELEMENT NAME → Space Grotesk
        function Tab:CreateToggle(opt)
            ...
            t.TextSize = 12
            t.Font = "GothamMedium"  -- 🔥 ELEMENT NAME → Space Grotesk
        ...
        -- SLIDER: ELEMENT NAME → Space Grotesk
        function Tab:CreateSlider(opt)
            ...
            l.TextXAlignment = "Left"
            l.TextSize = 11
            l.Font = "GothamMedium"  -- 🔥 ELEMENT NAME → Space Grotesk
        ...
        -- COLOR PICKER: ELEMENT NAME → Space Grotesk
        function Tab:CreateColorPicker(opt)
            ...
            -- COLOR PICKER NAME → Space Grotesk
        ...
        -- DROPDOWN: ELEMENT NAME → Space Grotesk, OPTIONS → Space Grotesk
        function Tab:CreateDropdown(opt)
            ...
            -- DROPDOWN TEXT → Space Grotesk (GIỮ HOVER)
            ...
            local function refreshOptions()
                ...
                for _, option in pairs(newOptions) do
                    -- DROPDOWN OPTIONS → Space Grotesk (XÓA HOVER)
                    ...
                    it.Font = "GothamMedium"  -- 🔥 ELEMENT NAME → Space Grotesk
                    it.TextSize = 11
        ...
        -- RUNBOX: PLACEHOLDER → Inter, BUTTON → Space Grotesk
        function Tab:CreateRunBox(opt)
            ...
            r.Font = "GothamBold"  -- 🔥 ELEMENT NAME → Space Grotesk
            r.TextSize = 10
